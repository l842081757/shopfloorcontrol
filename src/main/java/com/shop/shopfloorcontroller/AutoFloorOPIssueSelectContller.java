 ...
 */
@Controller
public class AutoFloorOPIssueSelectContller {
    ...
    @RequestMapping(value = "/AllfloorOPissueSelect",method = RequestMethod.POST)
    public String AutoFloorRobot(@RequestParam(value = "FloorName",required = true,defaultValue = "D073F")String FloorName,Map map,@RequestParam("dateinput1")String dateinput1,@RequestParam("dateinput2")String dateinput2){
        ...
        for (int i = 0; i < autofloor_targetAll.size(); i++) {
            ...
            //投首漏扫描
            AUTOFLOOR_OP_ISSUE autofloor_op_issues2 = autoFloor_op_issueService.OPISSUE_ERROR_TYPE2OneDay(dateinput1, dateinput2,lineName);
            ...
            AUTOFLOOR_OP_ISSUE autofloor_op_issues3_8 = autoFloor_op_issueService.OPISSUE_ERROR_TYPE3_8OneDay(dateinput1, dateinput2,lineName);
